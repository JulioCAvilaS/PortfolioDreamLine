...
function imprimeDados(data) {
    ...
    const { nome: nomeContato, estudio: estudioContato, endereço, bio: bioContato, fotoperfil, fotos, linkInsta: insta, linkEmail: email, linkWhatsApp: whatsapp } = data[0];
    ...
    endereco.innerHTML = `<p>${endereço}</p>`;
...
document.addEventListener('DOMContentLoaded', (event) => {
    ...
    if (valorAvaliado) {
        ...
        console.log('Estrela carregada do localStorage: ', valorAvaliado);
    }
